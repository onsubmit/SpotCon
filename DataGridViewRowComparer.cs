// -----------------------------------------------------------------------
// <copyright file="DataGridViewRowComparer.cs" company="Andy Young">
...
namespace SpotCon
{
    ...
    public class DataGridViewRowComparer : System.Collections.IComparer
    {
        ...
        /// <summary>
        /// Initializes a new instance of the DataGridViewRowComparer class
        /// </summary>
        /// <param name="column">Column to sort by</param>
        /// <param name="sortOrder">Ascending or descending</param>
        /// <param name="type">Type of values being compared</param>
        public DataGridViewRowComparer(int column, SortOrder sortOrder, Type type)
        {
            this.column = column;
            this.type = type;
